...
const Input: React.RefForwardingComponent<InputRef, InputProps> = (
  ...
  const [isFocused, setIsFocused] = useState(false); //Se tem o foco
  ...
  const handleInputBlur = useCallback(() => {
    setIsFocused(false); //Tira o foco

    //Verifica se o Iput tem o valor. Se tem coloca true, senão coloca false.
